...
# then use your neutral network to predict a future price
...
# Step 6 In this function, build your neural network model using Keras, train it,
# then have it predict the price on a given day. We'll later print the price out
# to terminal
